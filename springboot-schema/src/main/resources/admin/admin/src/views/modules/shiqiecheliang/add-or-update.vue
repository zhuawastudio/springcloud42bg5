	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="失窃位置" prop="shiqieweizhi">
					<el-input v-model="ruleForm.shiqieweizhi" placeholder="失窃位置" clearable  :readonly="ro.shiqieweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="失窃位置" prop="shiqieweizhi">
					<el-input v-model="ruleForm.shiqieweizhi" placeholder="失窃位置" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="车座" prop="chezuo">
					<el-input v-model="ruleForm.chezuo" placeholder="车座" clearable  :readonly="ro.chezuo"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="车座" prop="chezuo">
					<el-input v-model="ruleForm.chezuo" placeholder="车座" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='shiqieweizhi'){
							this.ruleForm.shiqieweizhi = obj[o];
							this.ro.shiqieweizhi = true;
							continue;
						}
						if(o=='chezuo'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shiqiecheliang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shiqiecheliangCrossAddOrUpdateFlag = false;
						 this.parent.search();
