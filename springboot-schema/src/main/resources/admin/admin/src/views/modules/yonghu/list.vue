		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"10%","padding":"0 10px","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","flexDirection":"column","display":"flex"}'>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('yonghu','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' v-if="isAuth('yonghu','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 10px 8px 0","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"32px"}' v-if="isAuth('yonghu','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
